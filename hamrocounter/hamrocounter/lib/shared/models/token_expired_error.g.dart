...
class _$TokenExpiredError extends TokenExpiredError {
  ...
  final String? code;
  @override
  final BuiltList<TokenExpiredErrorMessage> messages;
  ...
  _$TokenExpiredError._({this.code, required this.messages}) : super._() {
    BuiltValueNullFieldError.checkNotNull(
        messages, r'TokenExpiredError', 'messages');
  }
  ...
  @override
  int get hashCode {
    return $jf($jc($jc(0, code.hashCode), messages.hashCode));
  }
...
class TokenExpiredErrorBuilder
  ...
  ListBuilder<TokenExpiredErrorMessage>? _messages;
  ListBuilder<TokenExpiredErrorMessage> get messages =>
      _$this._messages ??= new ListBuilder<TokenExpiredErrorMessage>();
  set messages(ListBuilder<TokenExpiredErrorMessage>? messages) =>
  ...
  _$TokenExpiredError _build() {
    ...
    try {
      _$result = _$v ??
          new _$TokenExpiredError._(code: code, messages: messages.build());
    } catch (_) {
