...
import '../../utils/enums/enum_collections.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Builder(
      builder: (BuildContext context) {
        final UserAuthState authState = context.watch<UserAuthBloc>().state;
        final UserType userType = context.watch<RemoteConfigRepository>().state;
        return SafeArea(
          top: true,
          child:Scaffold(
          appBar:  AppBar(
              title: const TextView(text: 'Home', color: Colors.white,),
              centerTitle: true,
              actions: <Widget>[
                authState is Authenticated
                ? IconButton(
                  onPressed: (){
                    appState.userAuthenticationBloc.add(const LogoutUser());
                    showsnackBar(message: 'User Logout', context: context);
                  },
                ...
                TextButton(
                  onPressed: (){},
                  child: TextView(
                    text:  userType == UserType.vip ? 'Vip':'Normal',
                    color: Colors.white,
                  )
                ),
              ],
          ...
          bottomSheet: _bottomSheet(widthScreen),
        )
    );},
  );
  }

  Widget _bottomSheet(double widthScreen) {
    return Container(
                  ...
                  child: Padding(
                    ...
                    child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        backgroundColor: const Color(0xff19ACAC),
