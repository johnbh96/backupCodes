...
class JsonSimpleTextBuilder extends JsonWidgetBuilder {
  JsonSimpleTextBuilder({
    this.locale,
    this.maxLines,
    this.overflow,
    this.semanticsLabel,
  ...
  /// }
  static JsonSimpleTextBuilder? fromDynamic(
    dynamic map, {
    JsonWidgetRegistry? registry,
  }) {
    JsonSimpleTextBuilder? result;
    if (map != null) {
      result = JsonSimpleTextBuilder(
